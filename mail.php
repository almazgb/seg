...
$mail->Subject = 'Осаго';
$mail->Body    = '<br> Фамилия: '.$SureName.'<br>Имя: '.$Name.'<br> Отчество'.$NameSure. '<br> Номкр: '.$number.'<br> Количество лошадиных сил'.$force.'<br> Территория прописки '.$ter.'<br> Дату с которой должен действовать полис ' .$data .''.$email;
$mail->AltBody = '';
